...
train_file_list = 'test_data/debug.csv'
train_audio_root = 'test_data/audio'
train_output_root = 'test_data/process'

eval_file_list = 'test_data/debug.csv'
eval_audio_root = 'test_data/audio'
eval_output_root = 'test_data/process'
