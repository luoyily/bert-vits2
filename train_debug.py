...
from data_utils import FolderDataset, TextAudioSpeakerCollate
...
# If encontered training problem,please try to disable TF32.
...
def train_and_evaluate(
    ...
    for batch_idx, (
        ...
        if net_g.use_noise_scaled_mas:
            ...
            net_g.current_mas_noise_scale = max(
